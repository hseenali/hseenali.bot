...
*/
      ...
      $bot->sendMessage([
              ...
              file_put_contents("$from_id/POBGE9","off");
                   $bot->sendMessage([
                 'chat_id'=>$id,
...
*/
      ...
      $bot->sendMessage([
              ...
              file_put_contents("$from_id/VBBBB3","off");
                   $bot->sendMessage([
                 'chat_id'=>$id,
                  'text'=>"٭ تم صنع بوت جديد في الصانع الخاص بك 📝
            -----------------------
...
'text'=>"تم حظرك ",
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/VBBBB3/59",
                   'caption'=>'𓊈 𝑊𝐸𝐿𝐿𝐶𝑀𝐸 𓊉 𓁹 التفعيل بواسطة @VBBBB3',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
          	...
          	if($config['mode'] != null){
                  ...
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>' قناتي❗','url'=>'t.me/POBGE9'],['text'=>'المطور❔','url'=>'t.me/VBBBB3']],
                      ]
                  ])
                  ]);
...
*/
                 ...
                 'chat_id'=>$chatId,
                  'text'=>"",
		              ...
		              mkdir("$chatId");
		              file_put_contents("$chatId/VBBBB3","on1");
     ...
     $bot->sendMessage([
                      ...
                      'text'=>"معلومات البوت 
                      بوت مجاني
                      لشراء ملف البوت تواصل معاء المطور @VBBBB3 
                قناتي      @POBGE9",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
...
*/
          	...
          	file_put_contents("$from_id/1/VBBBB3","off");
             $bot->editMessageText([
		                			'chat_id'=>$chatId,
		         		                      'message_id'=>$mid,
